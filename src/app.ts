...
ComponentRegistry.createRegistry().register(
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const paneTitleIpt = document.querySelector(
        'input[name=paneTitle]'
    ) as HTMLInputElement;
    ...
    toggleHeaderBtn.addEventListener('click', () => {
        ...
        toggleHeaderBtn.innerHTML = `Toggle Header: ${alwaysShowHeader
            .toString()
            .toUpperCase()}`;
    ...
    toggleSettingsBtn.addEventListener('click', () => {
        ...
        toggleSettingsBtn.innerHTML = `Toggle Header: ${isSettingsVisible
            .toString()
            .toUpperCase()}`;
        navigationView.toggleAttribute(
            'is-settings-visible',
            isSettingsVisible
        );
    });
